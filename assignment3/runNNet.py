...
def test(netFile, e, dataSet, model='RNN', trees=None):
    if trees==None:
...
def makeconf(conf_arr, e, dataset):
    ...
    plt.savefig("images/RNN2_conf_epochs_{}_{}.png".format(e, dataset))
